...
- REST API built with AWS Lambda
- API Gateway routing with proxy integration
- MySQL database hosted on Amazon RDS
- Frontend built with HTML, CSS, JavaScript, and jQuery
- Client-side validation and error handling
- Automatic success/error message clearing
